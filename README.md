...
- BSc Industrial & Production Engineering | AUST, Bangladesh

Technical Skills & Tools
- Data Analysis: Python (Pandas, basic scripting), Excel (Reports, KPI, Automation), Power BI/Tableau basics
- Logistics & Operations: Supply Chain, Inventory, KPI Analysis, Automation
- Other: Git, basic programming projects, Multitasking in high-pressure environments
